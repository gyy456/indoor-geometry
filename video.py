...
def images_to_mp4(image_paths, output_path, fps=30):
    ...
    writer.close()
folder_path = 'output_new_data_a3_half/00000/train/ours_30000/renders_depth'  # 替换为你图片所在文件夹的路径
output_path = 'output_new_data_a3_half/00000/train/ours_30000/renders_depth/depth_video.mp4'  # 输出视频的路径和文件名
